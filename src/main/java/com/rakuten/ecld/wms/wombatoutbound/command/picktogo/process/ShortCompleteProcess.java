...
public class ShortCompleteProcess extends AbstractBaseStepHandler<PtgState> {
    ...
    @Override public void process(CliHandler<PtgState> cliHandler) {
        ...
        if ("y".equals(input)){
            ...
            cliHandler.response(messageSourceUtil.getMessage("outbound.common.short.login_complete",new String[]{"1"}));
        }
        else {
            ...
            cliHandler.response(messageSourceUtil.getMessage("outbound.common.short.login_complete",new String[]{input}));
        }
