...
@Component
@Slf4j
public class ShortProcess extends AbstractBaseStepHandler<PtgState> {

    @Override public void process(CliHandler<PtgState> cliHandler) {
        log.info("in short question process");

        cliHandler.response(messageSourceUtil.getMessage("outbound.common.short.login"));
    }
}
